...
import StuffForm from "~/src/components/panel/pages/Stuffs/Form";
...
const headers = [
    ...
    { field: "Email", align: "left", w: 300 },
    { field: "Phone", align: "left", w: 300 },
    // { field: "Role", align: "left", w: 300 },
...
const StuffList = () => {
    ...
    const { data, isFetching } = useFetchUsersQuery(
        `fields=id,first_name,last_name,avatar,email,phone&type=system&relations[]=role&limit=${params.limit}&offset=${params.offset}${
    ...
    const [deleteItem, result] = useDeleteUserMutation();
    ...
    return (
        <>
            <AppDialog
                title={`${!isUninitialized && selectedId ? "Update" : "Add"} User`}
                opened={opened}
                close={closeHandler}
            >
                <StuffForm
...
StuffList.layout = (page: any) => <Panel children={page} title="Stuffs" />;
